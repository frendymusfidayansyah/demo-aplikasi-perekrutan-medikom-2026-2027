    ...
    <style>
        ...
        * {
        ...
        .hero-logo {
            max-width: 200px;
            border-radius: 20px;
            box-shadow: 0 0 60px rgba(245, 205, 31, 0.3), 0 0 120px rgba(255, 107, 205, 0.2);
            margin: 10px 0 20px;
    ...
    <div id="page1" class="page active">
        <div class="main-wrapper">
            ...
            <header class="hero">
                ...
                <p class="sub-glow">
                    <i class="fas fa-bolt"></i> SUB-ORGANISASI MEDIA & TEKNOLOGI · 2026 <i class="fas fa-bolt"></i>
                </p>
            </header>
            ...
            <div class="marquee-wrap">
                <div class="marquee-inner">
                    ✦ MEDIKOM SMAN 2 JAKARTA ✦ SUB-ORGANISASI MEDIA & TEKNOLOGI ✦ KREATIVITAS TANPA BATAS ✦
                    ✦ MEDIKOM SMAN 2 JAKARTA ✦ SUB-ORGANISASI MEDIA & TEKNOLOGI ✦ KREATIVITAS TANPA BATAS ✦
                </div>
            </div>
    ...
    <script>
        (function() {
            ...
            const fasilitasData = [
                ...
                { image: "ILUSTRASI Id card.png", name: "ID Card Anggota", date: "Identitas Resmi", desc: "Kartu identitas resmi anggota MEDIKOM." },
